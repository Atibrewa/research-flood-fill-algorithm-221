...
class ViewPort:
	...
	def init_view(self):
		...
		t2 = Text(Point(105, -6), '(100,0)')
		t2.setSize(8)
		t2.draw(win)
		t2 = Text(Point(self.xVmax, self.yVmax), '(' + str(self.xVmax) + str(self.yVmax) + ')')
		t2.setSize(8)
		t2.draw(win)

		t3 = Text(Point(-2, 105), '(0,100)')
		t3.setSize(8)
		t3.draw(win)
		t3 = Text(Point(self.xVmax, self.yVmax), '(' + str(self.xVmax) + str(self.yVmax) + ')')
		t3.setSize(8)
		t3.draw(win)
